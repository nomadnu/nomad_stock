...
US_RECOMMEND_TIME = "20:00"         # 미국주식 추천 시각 (KST, 밤 8시 · v2에서 9시→8시). 추천만·매매 없음.

LONG_ALERT_DAY = 3                 # 트랙C 장기 편입 알림 요일 (0=월 ... 3=목)
LONG_ALERT_TIME = "20:00"          # 트랙C 장기 알림 시각 (KST, 주 1회 목요일 밤 8시 · v2에서 9시→8시)

# 대시보드 벤치마크 (트랙별 시장 대비 비교)
TRACK_A_START = "2026-07-03"       # 트랙A(한국) 매매 시작 기준일 — 코스피200 대비 비교 시작점 (실제 첫 매매일로 조정 가능)
